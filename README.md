...
1) Build HRNet React app with the 4 JQuery plugins as components.
2) Select one of the JQuery plugin, and build a React plugin
...
## Data location
MOCKDATA.json file is located in src/data with 50 employees.
A file called MOCKDATA1000.json (1000 employees) is also available, and can be used after renaming to MOCKDATA.json
## Data loading
Data loading is available when app is running.To load the employees from MOCKDATA.json:
